...
const SidebarGroup: FC<SidebarGroupPropsType> = (props) => (
	<div
		{...props}
...
const SidebarGroupLabel: FC<SidebarGroupLabelPropsType> = (props) => (
	<span
		{...props}
		className={cn(
			'text-muted-foreground text-sm group-data-[state=close]/sidebar:hidden',
			props.className
		)}
	/>
)
...
const SidebarGroupContent: FC<SidebarGroupContentPropsType> = (props) => (
	<div
		{...props}
		className={cn(
			'mt-2 flex flex-col gap-0.5 group-data-[state=close]/sidebar:m-0',
			props.className
		)}
	/>
)
...
const SidebarGroupItem: FC<SidebarGroupItemPropsType> = ({
	...
	return (
		<div
			{...props}
			className={cn(
				'text-lg font-semibold flex items-center gap-2 p-1 hover:bg-secondary relative',
				className
			)}
		>
